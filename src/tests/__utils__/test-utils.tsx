...
export function createMockIPC(): NekoCodeIPC {
  return {
    ...
    git: {
      ...
      getLog: vi.fn().mockResolvedValue({ commits: [], total: 0 }),
      getDiff: vi.fn().mockResolvedValue({ patch: '' }),
      getDiffSummary: vi.fn().mockResolvedValue({ files: [], insertions: 0, deletions: 0 }),
      stage: vi.fn().mockResolvedValue(undefined),
      unstage: vi.fn().mockResolvedValue(undefined),
      stageAll: vi.fn().mockResolvedValue(undefined),
      unstageAll: vi.fn().mockResolvedValue(undefined),
      commit: vi.fn().mockResolvedValue({ hash: '', hashAbbrev: '', branch: '' }),
      push: vi.fn().mockResolvedValue(undefined),
      pull: vi.fn().mockResolvedValue({ changed: false, fileChanges: 0, insertions: 0, deletions: 0 }),
      fetch: vi.fn().mockResolvedValue(undefined),
      branchList: vi.fn().mockResolvedValue({ branches: [], current: null }),
      branchCreate: vi.fn().mockResolvedValue(undefined),
      branchSwitch: vi.fn().mockResolvedValue(undefined),
